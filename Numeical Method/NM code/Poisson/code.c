...
#include<stdlib.h>
#include<math.h>
float fx1(float u2, float u3){
    float u1;
    u1 = (150+u2+u3)/4;
    return u1;
}
float fx2(float u4, float u1){
    float u2;
    u2 = (180+u4+u1)/4;
    return u2;
}
float fx3(float u1, float u4){
    float u3;
    u3 = (120+u1+u4)/4;
    return u3;
}
float fx4(float u2, float u3){
    float u4;
    u4 = (150+u2+u3)/4;
    return u4;
}
int main(){
    ...
    do
    {
        ...
        e2 = fabs((u2-tempu2)/u2);
        e3 = fabs((u3-tempu3)/u3);
        e4 = fabs((u4-tempu4)/u4);
